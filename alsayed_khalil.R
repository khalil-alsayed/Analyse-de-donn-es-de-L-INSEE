...
for (i in 0:100)
  A[i+1,3]<-ODD[39089+7*i,28]+ODD_DEP[39089+7*i+2,28]
...
for (j in 1:7)
  for (i in 1:101)
    o[i,j]<-0
for (i in 0:100)
  o[i+1,]<-c(ODD[61680+7*i,24],ODD_DEP[61680+1+7*i,24],ODD[61680+2+7*i,24],ODD[61680+3+7*i,24],ODD[61680+4+7*i,24],ODD[61680+5+7*i,24],ODD[61680+6+7*i,24])
